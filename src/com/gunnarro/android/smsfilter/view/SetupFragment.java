...
public class SetupFragment extends Fragment implements TimePickerSelectedListener {
    ...
    public void onTimeSet(int hourOfDay, int minute) {
        CustomLog.d(SetupFragment.class, "selected time: " + hourOfDay + ":" + minute);
    }
    ...
    private void setupEventHandlers(final View view) {
         ...
         * fromTimePicker.setOnTimeChangedListener(new OnTimeChangedListener() {
         * public void onTimeChanged(TimePicker view, int hourOfDay, int minute)
         * { filterService.updateMsgFilterPeriod(SettingTable.
         * SMS_FILTER_PERIOD_FROM_TIME, hourOfDay); } });
         * 
         * TimePicker toTimePicker = (TimePicker)
         * view.findViewById(R.id.msg_filter_to_time);
         * toTimePicker.setOnTimeChangedListener(new OnTimeChangedListener() {
         * public void onTimeChanged(TimePicker view, int hourOfDay, int minute)
         * { filterService.updateMsgFilterPeriod(SettingTable.
         * SMS_FILTER_PERIOD_TO_TIME, hourOfDay); } });
         */
    }
    ...
    private void updateMsgFilterPeriod(View view, boolean isEnabled) {
        ...
        String fromHour = Integer.toString(this.filterService.getMsgFilterPeriodFromHour());
        if (fromHour.length() == 1) {
            fromHour = "0" + fromHour;
        }
        fromTime.setText(fromHour + ":00");
        fromTime.setEnabled(isEnabled);

        TextView toTime = (TextView) view.findViewById(R.id.msg_filter_to_time_value);
        String toHour = Integer.toString(this.filterService.getMsgFilterPeriodToHour());
        if (toHour.length() == 1) {
            toHour = "0" + toHour;
        }
        toTime.setText(toHour + ":00");
